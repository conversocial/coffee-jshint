...
var CoffeeReactTransform, CoffeeScript, buildTrueObj, defaultOptions, errorsToSkip, formatErrors, fs, hint, hintFiles, jshint, _;
...
errorsToSkip = ["Did you mean to return a conditional instead of an assignment?", "Confusing use of '!'.", "Wrap the /regexp/ literal in parens to disambiguate the slash operator.", "Creating global 'for' variable. Should be 'for (var", "Missing '()' invoking a constructor.", "Bad number '2e308'."];
...
hint = function(coffeeSource, options, globals) {
  ...
  _ref = CoffeeScript.compile(coffeeSource, csOptions), js = _ref.js, v3SourceMap = _ref.v3SourceMap, sourceMap = _ref.sourceMap;
